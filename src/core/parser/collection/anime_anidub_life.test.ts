...
describe('anidub.life', function() {
  ...
  test('anime_movie', async function() {
    const url = 'https://anidub.life/anime_movie/11143-boku.html';
  ...
  test('full', async function() {
    const url = 'https://anidub.life/full/11153-tonikaku.html';
    const content = await getContent(page, url);
    const dom = new JSDOM(content, {
      url
    });
  ...
  test('anime_ova', async function() {
    const url = 'https://anidub.life/anime_ova/11522-teken.html';
    const content = await getContent(page, url);
    const dom = new JSDOM(content, {
      url
    });
  ...
  test('anime_ona', async function() {
    const url = 'https://anidub.life/anime_ona/10983-levius-levius-01-iz-12.html';
    const content = await getContent(page, url);
    const dom = new JSDOM(content, {
      url
    });
  ...
  test('anime_ongoing', async function() {
    const url = 'https://anidub.life/anime_ongoing/11643-adskij-raj-jigokuraku-01-iz-13.html';
    const content = await getContent(page, url);
    const dom = new JSDOM(content, {
      url
    });
  ...
  test('anime_tv', async function() {
    const url = 'https://anidub.life/anime_tv/11100-idolish7-vtoroy-takt-idolish7-second-beat-04-iz-12.html';
    const content = await getContent(page, url);
    const dom = new JSDOM(content, {
      url
    });
